 ...
 * <p>
 * This class will be instantiated only once and will use the JVM's default
 * locale.
 * </p>
 *
 * @author Nilhcem
...
public enum I18n {
     ...
     * <p>
     * If the JVM's default locale doesn't have any resource file, will take the
     * en_US resources instead.
     * </p>
     */
    private I18n() {
     ...
     * </p>
     *
     * @param key a String representing the key we want to get the resource
     * from.
     * @return The text corresponding to the key passed in parameters, or an
